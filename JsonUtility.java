...
public class ConversionUtility {
	...
	// ex.{{"payer":{account:123}},{"payee":{account:123}}} if want payer ac then key `payer|account`

	@SuppressWarnings("unchecked")
	public static Object getValueByKeyMultipleKeys(String pKay, String pPayload) {
		String[] lKeyArr = pKay.split("\\|");
		Object lObj = convertStringToMap(pPayload);
		if (lKeyArr.length > 0) {
				...
				if (lObj != null) {
					if (lObj instanceof Map) {
						...
						for (Object aObj : (List<?>) lObj) {
							Object lFoundObjectFromArray = getValueByKeyFromListOfMap(key, (Map<String, Object>) aObj);
				...
				if (entry.getValue() != null) {
					if (entry.getValue() instanceof Map) {
						...
						for (Object aObj : (List<?>) entry.getValue()) {
							Object lFoundObjectFromArray = getValueByKeyFromListOfMap(pKay, (Map<String, Object>) aObj);
							if (lFoundObjectFromArray != null)
